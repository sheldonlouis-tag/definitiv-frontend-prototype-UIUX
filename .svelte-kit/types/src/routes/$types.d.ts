...
type LayoutRouteId = RouteId | "/" | "/(auth)/signin" | "/admin/payroll" | "/admin/payroll/accrual-types" | "/admin/payroll/pay-items" | "/employee/cost-centers" | "/employee/cost-centers/projects" | "/employee/details" | "/employee/employee" | "/employee/employee/my-details" | "/employee/finance" | "/employee/finance/banking" | "/employee/financial" | "/employee/financial/bank-accounts" | "/employee/leave" | "/my-team/employees" | "/my-team/employees/[id]" | "/my-team/onboarding" | "/my-team/timesheets" | null
