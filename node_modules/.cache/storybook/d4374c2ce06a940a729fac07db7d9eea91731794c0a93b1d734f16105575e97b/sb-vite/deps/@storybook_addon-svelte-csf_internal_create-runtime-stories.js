...
function StoriesExtractor($$anchor, $$props) {
  ...
  add_svelte_meta(
    () => component(node, () => $$props.Stories, ($$anchor2, Stories_1) => {
      Stories_1($$anchor2, {});
    }),
    "component",
    StoriesExtractor,
...
var skipSourceRender = (context) => {
  ...
  if (sourceParams?.type === Tn.DYNAMIC) {
    return false;
  }
  return !isArgsStory || sourceParams?.code || sourceParams?.type === Tn.CODE;
};
